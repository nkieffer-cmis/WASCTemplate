...
{
\noindent\textbf{\sffamily Findings}
...
\noindent\textbf{\sffamily Indicator:} #1
}

\newcommand{\prompt}[1]{ 
\noindent\textbf{\sffamily Prompt:} \textit{#1}
}
...
{\Huge\bfseries\raggedright}{}{0em}{\colorbox{CmisPurple}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{\textcolor{white}{\sffamily#1}}}}
...
{\sffamily\bfseries\Large\color{CmisPurple!110}}
{}
{0pt}
